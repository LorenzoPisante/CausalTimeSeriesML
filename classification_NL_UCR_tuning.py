...
from codesN import k_cross_validation_refined_search2
...
#    Y_test = keras.utils.to_categorical(y_test, nb_classes)
    ...
    #INA, DT, EPSILON_1, best_metric=k_cross_validation_refined_search2(datasets, 6)
    
    # ChaosFEX feature Extraction
    feat_mat_traindata = CFX.transform(x_train, INA, 1000, EPSILON_1, DT)
    feat_mat_testdata = CFX.transform(x_test, INA, 1000, EPSILON_1, DT)
    ...
    print("ChaosFEX - Accuracy-score for ",fname, "with ", best_metric ,"metric is ", ACC)
