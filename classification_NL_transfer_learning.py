# -*- coding: utf-8 -*-
"""
Created on Sat May 25 20:38:38 2024
...
for COUP_COEFF in COUP_COEFF1:
    ...
    RESULT_PATH = PATH + '/DATA/'  + DATA_TL + '/' + str(COUP_COEFF) +'/'
    # Loading the normalized Raw Data
    Y_independent_data = io.loadmat(RESULT_PATH + 'Y_independent_data_class_0.mat')
    Y_independent_label = io.loadmat(RESULT_PATH + 'Y_independent_label_class_0.mat')
...
plt.show()
np.save(rf"C:\Users\loren\Desktop\EXP_REPORT\NL\generalization\transfer_learning_NL_TM_2", F1_score_Result_array)    
